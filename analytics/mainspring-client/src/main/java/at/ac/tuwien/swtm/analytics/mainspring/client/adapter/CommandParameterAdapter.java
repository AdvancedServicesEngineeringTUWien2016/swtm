...
public class CommandParameterAdapter {

    private String value;
    private String name;
    private CommandParameter param;

    public CommandParameterAdapter() {
    }

    public CommandParameterAdapter(final CommandParameter param) {
        this.param = param;
    }
    ...
    public String toString() {
        return "CommandParameterAdapter{" + "value=" + value + ", name=" + name + ", param=" + param + '}';
    }
