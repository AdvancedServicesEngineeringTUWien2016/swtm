...
public class SensorDataAdapter {
    private String name;
    private List<AttributeDataAdapter> adapters = new LinkedList<AttributeDataAdapter>();
    ...
    public List<AttributeDataAdapter> getAttributes() {
        return adapters;
    }
    
    public void setAttributes(List<AttributeDataAdapter> adapters) {
