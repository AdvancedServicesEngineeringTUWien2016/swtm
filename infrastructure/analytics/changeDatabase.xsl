...
<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="//ds:subsystem/ds:datasources/ds:datasource[@jndi-name='java:jboss/datasources/ExampleDS']">
		<ds:datasource jndi-name="java:jboss/datasources/AnalyticsDS" pool-name="AnalyticsDS" enabled="true" use-java-context="true">
			<ds:connection-url>jdbc:h2:mem:analytics;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE</ds:connection-url>
